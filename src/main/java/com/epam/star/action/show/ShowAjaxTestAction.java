...
public class ShowAjaxTestAction implements Action {
    private ActionResult ajaxTest = new ActionResult("ajaxTable");
...
//        pagination.executePaginationAction(request, clientDao, "dispatcher", "clients");
        pagination.executePaginationAction(request, orderDao, "ajaxTable", "orders");
